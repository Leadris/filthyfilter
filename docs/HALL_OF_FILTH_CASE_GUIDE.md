...
## 4. Reciprocita a credits

- Krátko predstaviť zákazníka a to, čo na ňom terénny tím úprimne odporúča.
- Overené fakty (adresa, kontakt, ponuka) oddeliť od osobného odporúčania.
...
- MP4 aj WebM sa načítajú, video má poster a funguje mobilný layout.
- Credits obsahujú zdroj grafiky, dátum prístupu a stav súhlasu.
- Po nasadení overiť homepage, detail, obrázky a byte-range prehrávanie videa.
